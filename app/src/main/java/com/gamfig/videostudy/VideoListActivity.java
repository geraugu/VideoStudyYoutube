...
@TargetApi(13)
public class VideoListActivity extends AppCompatActivity implements OnFullscreenListener {
    ...
    private static String idTvSenado = "UCLgti7NuK0RuW9wty-fxPjQ";
    private String idTvCamara = "UC-ZkSRh-7UEuwXJQ9UMCFJA";
    ...
    private static final class PageAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (view == null) {
                ...
                thumbnail.initialize(Config.DEVELOPER_KEY, thumbnailListener);
            } else {
                YouTubeThumbnailView thumbnail = (YouTubeThumbnailView) view.findViewById(R.id.thumbnail);
